...
Thirteen features, thirteen user stories — one per row in §4. Click a role to expand the stories for that role.

> **Roles legend** &nbsp;·&nbsp; 👤 Visitor &nbsp;·&nbsp; 🔐 Logged-in user &nbsp;·&nbsp; 🛠️ Project owner

<details>
<summary><b>👤 &nbsp;Visitor</b> &nbsp;—&nbsp; 5 stories (Register · Log in · Browse · Filter · View detail)</summary>
...
<details>
<summary><b>🔐 &nbsp;Logged-in user</b> &nbsp;—&nbsp; 6 stories (Log out · Create · Add to collection · Remove · Summary · My projects)</summary>
...
<details>
<summary><b>🛠️ &nbsp;Project owner</b> &nbsp;—&nbsp; 2 stories (Edit · Delete)</summary>
...
> [!NOTE]
> The first launch automatically creates the SQLite file and seeds one demo user plus sample projects across the five categories.
